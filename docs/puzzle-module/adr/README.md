...
| # | Title | Status |
|---|---|---|
| [0001](0001-shared-firebase-project-namespace-isolation.md) | Shared Firebase project with namespace isolation, not a project per app | Accepted |
...
| [0007](0007-shared-rules-file-via-symlink.md) | One physical Firestore/Storage rules file, symlinked, not duplicated | Accepted |
